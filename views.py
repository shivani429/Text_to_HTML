...
from .models import Emp,Employee,Blog,QuizModel,Student,Editor,Details,EmployeeSalary,Profile,CrudUser    
from demoapp.forms import LoginForm, QuizModelForm,StudentForm,EditorForm,DetailsForm,CreateUserForm,PhotoForm,ContactForm,EmpForm
...
def edit_data(request,id):
    form = Details.objects.get(id=id)
